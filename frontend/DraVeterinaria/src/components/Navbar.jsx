    ...
    <div className='absolute top-0 left-0 w-full z-10'>
        <div className='container mx-auto flex justify-between items-center px-6 py-4 md:px-20 lg:px-32 bg-transparent gap-4'>
            ...
            <ul className='hidden md:flex gap-7'>
                ...
                <button className="px-5 py-3 bg-transparent hover:bg-blue-500 text-blue-700 hover:text-white border border-blue-500 hover:border-transparent rounded" onClick={() => navigate("/agendamiento")} onClick={() => navigate("/agendamiento")}>Agenda cita</button>
            </ul>
